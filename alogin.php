        ...
        <div class="col-md-4 col-md-offset-4" style="text-align: center;">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:  #00cccc">
                  <center>  <span class="glyphicon glyphicon-lock"></span><b>&nbsp; Advanced User Login</b><center></div>
                <div class="panel-body"   style="background-color:#99ffff">
                    
                    <form action="login9.php?offset=1" class="form-horizontal" role="form" method='POST'>
                    <div class="form-group">
                        <label for="username3" class="col-sm-3 control-label">
                            Username</label>
                        <div class="col-sm-9">
